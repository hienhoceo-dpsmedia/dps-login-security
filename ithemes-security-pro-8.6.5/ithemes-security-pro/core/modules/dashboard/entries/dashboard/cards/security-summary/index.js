				...
				<StyledSection isSmall={ isSmall }>
					<StyledSectionTitle>
						<Text
							...
							weight={ 600 }
							text={ __( 'Latest in Solid Security News', 'it-l10n-ithemes-security-pro' ) }
						/>
					</StyledSectionTitle>
							...
							<StyledBlogText>
								...
								<Text as="p"
									...
									text={ sprintf(
										...
										__( 'Published - %s', 'it-l10n-ithemes-security-pro' ),
			...
			<StyledSection isSmall={ isSmall }>
				<StyledSectionTitle>
					<Text
						...
						variant={ TextVariant.DARK }
						weight={ 600 }
						text={ __( 'Vulnerabilities', 'it-l10n-ithemes-security-pro' ) }
					/>
					{ card.data.vulnerability &&
						<>
							...
							<Button
								...
								variant="link"
								text={ __( 'Fix Vulnerabilities', 'it-l10n-ithemes-security-pro' ) }
							/>
						</>
					}
				</StyledSectionTitle>
				{ card.data.vulnerability
					...
					: <Notice text={ __( 'Great news! There seem to be no vulnerable software installed!', 'it-l10n-ithemes-security-pro' ) } />
				}
			</StyledSection>
		</>
	);
